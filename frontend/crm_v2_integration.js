...
(function () {
    ...
    function wireBusiness360() {
        ...
        if (typeof original === 'function' && !original.__crmV2Wrapped) {
            const fn = function () { const r = original.apply(this, arguments); setTimeout(() => { if (this.currentPartyId) showPanel(this.currentType, this.currentPartyId, this.currentType === 'customer' ? 'Customer 360° — Connected Records' : 'Supplier 360° — Connected Records', document.getElementById('b360TabViewport') || document.body); }, 100); return r; }; fn.__crmV2Wrapped = true; window.B360UI.renderCurrentTab = fn;
        }
    }
