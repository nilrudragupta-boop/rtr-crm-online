...
function createWindow() {
    ...
    // Load your HTML file from the frontend directory
    win.loadFile(path.join(__dirname, '../frontend', HTML_FILE));
...
ipcMain.handle('show-whats-new', () => {
    ...
    whatsNewWindow.loadFile(path.join(__dirname, '../frontend/whatsnew.html'));
...
// startHeartbeat("Milan", "123-456-7890");